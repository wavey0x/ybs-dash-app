...
const fieldConfig = {
    ...
    peg_data: {
      ...
      swap_size: { visible: false, decimals: 2, label: 'Swap Size', isMultiplier: true },
      output_amount: { visible: true, decimals: 2, label: '10k Swap Output' },
      peg: { visible: true, decimals: 2, label: 'Peg', isPct: true },
      pool_balances: {
        visible: true,
        label: 'Pool Balances',
        group: [
          { key: 'balance_peg_token', decimals: 2, isUSD: false },
          { key: 'balance_ylocker_token', decimals: 2, isUSD: false },
        ],
        separator: ' | ',
      },
      balance_peg_token: {
    ...
    strategy_data: {
      ...
      swap_limits: {
        ...
        group: [
          { key: 'swap_min_usd', decimals: 2, isUSD: true },
          { key: 'swap_max_usd', decimals: 2, isUSD: true },
        ],
        separator: ' | ',
      },
